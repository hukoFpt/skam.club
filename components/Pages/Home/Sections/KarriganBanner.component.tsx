  ...
  return (
    <div className={`${styles["karrigan-banner-block"]} relative mb-[42px]`}>
      <div className="border-b border-[#55283b] justify-between w-[1316px] mx-auto px-2.5 pt-5 pb-1 relative flex z-1">
        <Image src="/images/home/karrigan-first-photo.png" alt="Karrigan Banner" width={363} height={352} />
        <div className="flex flex-col mt-24 items-center">
          <Image src="/images/home/karrigan-text.png" alt="Karrigan Banner" width={398} height={100} />
        ...
        <Image src="/images/home/karrigan-second-photo.png" alt="Karrigan Banner" width={369} height={372} />
      </div>
    </div>
  );
};
